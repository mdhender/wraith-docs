...
|autobot|Automation unit replacing workers.
...
|milbots|Automation unit replacing soldiers.
...
|orbital-drive|Engines used to move ships around a world and also when in combat.
|sensor|Active and passive scanning equipment.
|structure|Basic unit for constructing ships and colonies.
Combination Lego, Erector, and Ikea that can survive the stresses of space and hostile, radioactive worlds.
|structure, light|A lighter structure unit.
|structure, super-light|A much lighter structure unit.
...
Yes, we use mines to harvest timber and oil, too.
...
and even on large rocks in an asteroid belt.
