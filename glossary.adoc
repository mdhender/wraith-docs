...
enclosed colony::
An _enclosed colony_ is built on the surface of an uninhabitable *terrestial planet* or on an asteroid in an *asteroid belt*.
...
Planets may be *terrestrial* or an *asteroid belt*.
