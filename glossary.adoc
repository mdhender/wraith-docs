...
This includes things like crystals, gases (but never *fuel* units), and organic materials like silk (but never *food* units).
Non-metal units can be stored and transported.
Non-metal units must be mined and refined by *mining* units.
Note that metal units never include *gold*.
