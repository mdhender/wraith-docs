...
structural unit::
A _structural unit_ is used to enclose mass units (MUs).
An *open colony* requires 1 SUF to enclose 1 MU.
An *enclosed colony* requires 5 SUF to enclose 1 MU.
An *orbiting colony* requires 10 SU to enclose 1 MU.
A *ship* also requires 10 SU to enclose 1 MU.
