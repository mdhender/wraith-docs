...
Colonies and ships will usually participate in only combat per turn.
...
Format:
```
SystemID #Orbit QuotedText QuotedText?
```
...
=== Supress Foreign Spies Order
Format:
```
ColonyOrShipID Quantity supress
```
...
Format:
```
Player ID No., "control," System No., Orbit No.
