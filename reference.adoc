...
|HDRV|Hyper Drive|
|LFSP|Life Support|
|LSU|Light Structural|A type of structural unit built only in orbiting colonies.
|MILR|Military Robot|
...
|SSU|Structural|
|TRNS|Transport|
|UOTH|Unemployable|A group of 100 people that are not Unskilled Workers, Professional Workers, or Soldiers.
