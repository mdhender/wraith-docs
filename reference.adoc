...
WARNING: This doesn't allow for systems with multiple stars.
...
WARNING: This should probably just automatically use the smallest transport available.
...
WARNING: It is possible for both sides to surrender at the same time?

=== Independence Check Step
If the soldiers surrender, the colony or ship will declare its indepence.

The independent colony, if it has factories or mines, will seek out trade stations to sell their goods and purchase needed raw materials.

The idenpendent ship will support itself via raids or hiring out as mercenaries.
