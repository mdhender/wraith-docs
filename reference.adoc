...
[source]
----
bombard ColonyOrShipID SpeciesID ColonyOrShipID Percentage
----

.Combat Bombard Order Examples
[source]
----
bombard S27 SP18 C13 50%
----
...
[source]
----
invade ColonyOrShipID SpeciesID ColonyOrShipID Percentage
----

.Combat Invade Order Examples
[source]
----
invade S27 SP18 C13 50%
----
...
[source]
----
raid ColonyOrShipID SpeciesID ColonyOrShipID PercentCommitted AssetID Percent
----

.Combat Raid Order Examples
[source]
----
raid S27 SP18 C13 assault-weapon-5 10%
----
...
[source]
----
sabotage ColonyOrShipID SpeciesID ColonyOrShipID PercentCommitted AssetID Percent
----

.Combat Sabotage Order Examples
[source]
----
sabotage S27 SP18 C13 hyper-drive-5 10%
----
...
It should probably be just `sabotage S27 SP18 C13 hyper-drive 10%`.
...
[source]
----
support ColonyOrShipID SpeciesID ColonyOrShipID against SpeciesID Percent
support ColonyOrShipID SpeciesID ColonyOrShipID bombard SpeciesID ColonyOrShipID Percent
support ColonyOrShipID SpeciesID ColonyOrShipID invade  SpeciesID ColonyOrShipID Percent
----
...
[source]
----
support S14 SP12 S83 against SP18     100%
support S14 SP12 S83 bombard SP18 C13 100%
support S14 SP12 S83 invade  SP18 C13 100%
----
...
[source]
----
unassemble S52 200 life-support-3      ; take apart 200 units - 20 will be scrapped
...
[source]
----
unassemble S11 16 spy  ; disband 16 SPY by returning 16 PRO and 16 SLDR
----
...
[source]
----
assemble C8   5,000 factory-2 assault-craft-6
...
[source]
----
assemble C27 9,750 missile-launcher-2
assemble S52   200 life-support-3
----
...
[source]
----
expand ColonyID FactoryGroupID Quantity FactoryTL
----

.Expand Order Examples
[source]
----
expand C91 FG2 2,500 factory-2  ; add 2,500 FACT-2 units to the group
expand C91 FG2 1,800 factory-6  ; add 1,800 FACT-6 units to the group
----
...
[source]
----
expand ColonyID MiningGroupID Quantity MineTL
----

.Expand Order Examples
[source]
----
expand C91 MG2 2,500 mine-2  ; add 2,500 MINE-2 units to the group
expand C91 MG2 1,800 mine-6  ; add 1,800 MINE-6 units to the group
----
...
[source]
----
manufacture ColonyID FactoryGroupID Quantity UnitCodeTL
----

.Manufacture Order Examples
[source]
----
manufacture C91 FG9 50,000 missile-8
----
...
[source]
----
mine ColonyID MiningGroupID Quantity DepositID
----

.Mine Order Examples
[source]
----
mine C16 MG27 25,000 DP19
----
...
[source]
----
advertise SystemID #Orbit QuotedText QuotedText?
----

.Advertise Order Examples
[source]
----
advertise 8/4/3  #6 "Stay away from my moons" "Jinsei"
advertise 3/7/9A #6 "Fresh moon rocks for sell next turn"
----
...
[source]
----
sell SystemID #Orbit Quantity UnitTL Number
----
...
[source]
----
sell 8/4/3  #6 4 space drive-3       0.2
sell 3/7/9A #6 1 tech-4        800,000
----
...
[source]
----
buy SystemID #Orbit Quantity UnitTL Number
----
...
[source]
----
buy 8/4/3  #6 25,000 structural         0.01
buy 3/7/9A #6      1 tech-6     1,000,000
----
...
[source]
----
convert ColonyOrShipID Quantity
----
...
[source]
----
incite SpeciesID ColonyOrShipID Quantity
----
...
[source]
----
information SpeciesID ColonyOrShipID Quantity
----

.Information Order Examples
[source]
----
information S2 C54 900
----
...
[source]
----
suppress ColonyOrShipID Quantity
----
...
[source]
----
draft ColonyOrShipID Quantity professional
----

.Draft Professionals Order Examples
[source]
----
draft S1 3,000 professional
----

.Draft Soldiers Order
[source]
----
draft ColonyOrShipID Quantity soldier
----

.Draft Soldiers Order Examples
[source]
----
draft C8 16,000 soldier
----
...
[source]
----
disband ColonyOrShipID Quantity professional
----

.Disband Professionals Order Examples
[source]
----
disband C8 6,000 professional
disband S1     * professional
----

.Disband Soldiers Order
[source]
----
disband ColonyOrShipID Quantity soldier
----

.Disband Soldiers Order Examples
[source]
----
disband C8 6,000 soldier
disband S1     * soldier
----
...
[source]
----
ration ColonyOrShipID Percentage
----
...
[source]
----
control SpeciesID SystemID #Orbit
----
...
name ShipID                    QuotedString
name SpeciesID SystemID #Orbit QuotedString
----
...
[source]
----
uncontrol SpeciesID SystemID #Orbit
----

.Uncontrol Order Examples
[source]
----
uncontrol SP2 2/4/6 #9
----
