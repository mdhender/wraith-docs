...
All food being produced by the farm unit is lost.
...
Mine units produce no raw materials until they have been active for four consecutive turns.
...
Factories produce all units except for food, metals, non-metals, fuel, gold, and population units.
