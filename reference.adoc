...
Active is an operational item that has the required fuel and labor to be used.
...
The excess population are removed immediately.
The casualties are distributed uniformly across all population groups on the colony or ship.
...
A farm unit produces no food units if it is not active.
