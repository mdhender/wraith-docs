...
If a FACTORY GROUP does not have a full allocation of fuel, a portion will be INACTIVE for the current TURN.
...
If a FACTORY GROUP does not have a full allocation of labor, a portion will be INACTIVE for the current TURN.
...
|FACTORY|20 * TL MASS UNITS (MU) of finished goods
|===
